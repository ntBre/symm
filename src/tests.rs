...
fn test_point_group() {
    ...
    let tests = vec![
        ...
        Test {
            msg: "c3h3+",
            mol: "
        C       -0.002177587    -0.083646455    -0.000000000
        C       -0.730846250    -1.273155484    -0.000000000
        C        0.663634108    -1.309448453    -0.000000000
        H        1.584511654    -1.873559209     0.000000000
        H       -1.679820949    -1.788604338    -0.000000000
        H        0.025918886     0.995913164    -0.000000000
        ",
            pg: C2v {
                axis: X,
                planes: [Plane(X, Z), Plane(X, Y)],
